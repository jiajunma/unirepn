...
\subsection{``Special'' and ``non-special'' diagrams for type M}
...
$x_{0}$, $y_{0}$ and the rows contains them may be empty. % We remark that the
...
$(y_{0},y_{1},y_{2})$ is given by \Cref{tab:nonsp.M}.
The rest part of the diagrams are unchanged.
\begin{table}[hp!]
  % \begin{tabular}
  %   $\uptau$&&
