...
{
  \color{red}
  Here $\PBP_{*}(\_)$ denote the set of painted bi-partitions running
  over all relevant shapes.
}
...
\begin{proof}
  ...
  $\cP_{\lambda_{g}}(G_{g})$. By \Cref{lem:AV.HC}, this implies $\ffcoh$ restricted to an isomorphism
  \[
...
\section{Some case by case computation.}

{\color{red} The below will be merged with the definition of painted
  bi-partition and the computation of coherent continuation representations in
  various cases. }
