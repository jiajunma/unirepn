...
\begin{lem}
  ...
  \[
    \begin{split}
      ...
      \cC_b &= \bigoplus_{\substack{2t+a=n_{b}}} \Ind_{H_{t} \times S_a}^{W'_{n_{b}}} \hsgn\otimes 1
    \end{split}
  \]
  \qed
\end{lem}
...
\subsection{Counting special unipotent representation of $G=\SO(p,q)$ with
$p+q=2n+1$ }.

The dual group of $\Gc = \SO(2n,\bC)$ is $\ckGc = \SO(2n+1,\bC)$.

We set $(2n,2n') = (\abs{\ckcO_g},\abs{\ckcO_b})$.
