...
We now discuss case by case according to the set $\set{\Sign((\tau_{i})_{\bftt})|i=1,2}$:
  \begin{enumPF}
   ...
   \Cref{lem:BD3}~(b), we deduces that $\ac_{\uptaupp_{1}}=\ac_{\uptaupp_{2}}$.
    ...
    \]
    which is contradict to \Cref{lem:BD3}~(c) for $\ckcO''$.
  \end{enumPF}
...
Note that
 ...
 \] 
  ...
  \end{enumPF}
  By the same argument in the proof of \Cref{lem:BD2}~(b), 
...
When $\nac{\uptau_{1}}=\nac{\uptau_{2}}=0$, by the similar argument in the proof of \Cref{lem:BD}~(b),
