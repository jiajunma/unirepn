...
Suppose $\star \in \set{B,D}$ and $\ckcO \neq \emptyset$.
  ...
  % \end{enumT}
    ...
    \begin{equation}\label{eq:up}
      \begin{array}{rcl}
        \Upsilon_{\ckcO} \colon \set{\ac_{\uptau}|\pac{\uptau}\neq 0, \uptau\in \PBPes(\ckcO)}
...
Thanks to \Cref{lem:BD2}~(a) and \eqref{eq:C}, we have $\pac{\uptaup} \neq 0$ and
\begin{equation}
\label{eq:dsign1}
  \dsign(\ac_{\uptau}) =
  \begin{cases}
...
$\nac{\uptau'_{1}}=\nac{\uptau'_{2}}$.
By the injectivity of $\Upsilon_{\ckcO'}$ in \Cref{lem:BD2}~(b), we get
...
We now assume $\bfcc_{2}(\cO)>0$ and retain the notation in \Cref{lem:BD,lem:BD2}.
