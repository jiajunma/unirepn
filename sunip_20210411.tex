...
Recall that $\ckcO$ is quasi-distinguished when $\star = C^*, D^*$. See \Cref{prop:CD*}. All the claims of this subsection for $\star\in \set{C^{*},D^{*}}$ are relatively straightforward to verify, and as such we shall only provide the details for the non-quaternionic cases in the next three sections.
