...
\begin{frame}[plain,label=tt]
    ...
    \vspace{-3em}
\centering{
    (Xiamen, Tianyuan Mathematical Cernter )
}
\end{frame}
...
% \begin{frame}[c]{Outline}
    ...
    \begin{frame}[label=DU]
        ...
        \begin{block}{Theorem (Barbasch-M.-Sun-Zhu)}
            Arthur-Barbasch-Vogan's conj.  on special unipotent repn. holds:
            \pause
    ...
    \begin{frame}[label=DU]
        ...
        \begin{itemize}[<+->]
            ...
            \item [] An irr. admissible $G$-module is called 
            ...
            $\bfG\cdot \AV(\pi) = \overline{\cO}$
            \item Here $\cO$ is the  Lusztig-Spaltenstein-Barbasch-Vogan dual of $\ckcO$,
            \item[] which is a \emph{(metaplectic) specail nilpotent orbit.}
   ...
   \delete{ 
    ...
    \begin{frame}
        ...
        \vfill
        \includegraphics[width=.5\textwidth]{paper_qr.png}
    \end{frame}
