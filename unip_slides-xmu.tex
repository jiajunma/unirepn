...
% \begin{frame}[c]{Outline}
    ...
    \begin{frame}[label=DU]
        ...
        \begin{itemize}[<+->]
            ...
            \item Barbasch-Vogan 1985: Complete classification of unipotent repn. of {\lblue complex reductive groups}. 
    ...
    \begin{frame}[label=CT]
        ...
        \begin{itemize}[<+->]
           ...
           \] 
           \item[] Double cell $\cD$  in $W(\lambda)$
           ...
           \item Let $\mu \in \lambda + Q$ ($Q$ is the root lattice), 
            \[
                W_\mu = \set{w\in W | w\cdot \mu = \mu}.  
            \]
            \item $\cK_{\lambda}(\fgg,K)$:  the Groth. gp. of $(\fgg,K)$-modules with inf. char. $\lambda$. 
            \item {\lblue Lemma: }
            \[
                \begin{split}
             & \#\set{\pi \in \Irr_{\mu}(\fgg,K)(G) | \AV_\bC(\pi) = \overline{\cO}}\\
            &= \sum_{\substack{\tau\in \cD\\\cD\leadsto \cO}} [\tau:1_{W_\mu}]\cdot [\tau: \cK_{\lambda}(\fgg,K)]
                \end{split}
            \]
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}{Reduction to the ``good parity''}
        \begin{itemize}[<+->]
            ...
            \begin{array}{ccc}
                ...
                (\pi_1,\pi_0 ) &\mapsto & \Ind_{\raisebox{-0.5em}{\tiny$\GL(\abs{\ckcO'_b},\bR)\times \Sp(2n_0,\bR)$}}^{\tiny\raisebox{1em}{$\Sp(2n,\bR)$}}
   ...
   \delete{ 
    ...
    \begin{frame}[label=CG]
        ...
        Kraft-Procesi's resolution  of singularities of the closure of complex nilpotent orbits. 
    \end{frame}
...
\let\ytb=\ytableaushort
    \begin{frame}[label=CG]
        ...
        \begin{tikzcd}[ampersand replacement=\&,column sep=1em,row sep=.5em]     
            ...
            \cO_i \& \ytb{-+-+\none,+-+-,+-+-,+-}\& \ytb{+-+,-+-,-+-,-} \& \ytb{-+\none,+-,+-,\none} \&
            \ytb{+,+,-,-\none\none}\\
            \bfG_i \&  \Sp(14,\bR) \&  \rO(4,6) \&  \Sp(6,\bR) \& \rO(2,2)\\
        \end{tikzcd} 
        \]
        \pause
        Ohta's resolution  of singularities of a nilpotent orbit closure in symmetric pairs. 
    \end{frame}
    ...
    \begin{frame}[label=CT]
        ...
        \begin{itemize}[<+->]
            ...
            \item $\cK_{\rho}(G)$:  the Groth. gp. of $(\fgg,K)$-modules with inf. char. $\rho$. 
            \item[]
            \vspace{-1em}
            \[
            \lblue
    ...
    \begin{frame}[label=CT]
        ...
        \begin{itemize}[<+->]
            ...
            \begin{tikzcd}[ampersand replacement=\&]
               ...
               \LS(\ckcO') \ar[u,"\text{geo. lift}"]\& \PBP(\ckcO') \ar[r,<->]\ar[l,"\AC"] \& \Unip_{\ckcO'}(G') \ar[u,"\theta"'] 
            \end{tikzcd}
            \]
