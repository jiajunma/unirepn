...
\begin{proof}
 ...
 $N'$. Let $\phi$ be the composition of $\tphi$ with the projcetion to $V''$
 under the above decomposition. By construction,  
 $\phi$ is an element in  $\Ms^{-1}(\bfee)\cap \cXsso$, 
  ...
  _\lambda \quad \forall \lambda \in \set{\pm 1, \pm \sqrt{-1}}. 
  \end{equation}
  Here $(\_)_{\lambda}$ denote the $\lambda$-eignspace of  $\Ls$ or $\Lsp$. 

 When $\rank(\bfee) = \dim V_{\sfss'}$, 
  the rest parts of the lemma was proved in \cite[Lemma 13]{Ohta}  

  When $\rank(\bfee)< \dim V_{\sfss'}$, the lemma is reduced to the previous
  case by the observation that the set 
  \[
...
\end{itemize}
Note that $\innsti{}{}$ is a uniquely determined by the condition upto a positive scalar. 
